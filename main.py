...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/bhanu_contact_bot")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/bhanu_contact_bot"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+3k-1jckxIjYwNGZl"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"╭────────⊰◆⊱────────╮\n"   
        f" ➠ 𝐌𝐚𝐝𝐞 𝐁𝐲 : [𝘽𝙃𝘼𝙉𝙐 𝘽𝙊𝙏𝙎](https://t.me/bhanu_contact_bot) 💻\n"
        f"╰────────⊰◆⊱────────╯\n"
        )
    )                    
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[𝄟⃝‌🐬🇼‌ᴀʀʀɪᴏʀ𝄟⃝🐬](https://t.me/+MdZ2996M2G43MWFl)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝘽𝙃𝘼𝙉𝙐 𝘽𝙊𝙏𝙎🐦](https://t.me/+MdZ2996M2G43MWFl)"
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"🛑**Send** /stop **to stop process**\n┃\n" \
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦
[𝘽𝙃𝘼𝙉𝙐 𝘽𝙊𝙏𝙎🐦](https://t.me/+MdZ299bM2g43MWFl)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"🛑**Send** /stop **to stop process**\n┃\n" \
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦
[𝘽𝙃𝘼𝙉𝙐 𝘽𝙊𝙏𝙎🐦](https://t.me/+MdZ2996M2G43MWFl)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"**⚡Dᴏᴡɴʟᴏᴀᴅɪɴɢ Sᴛᴀʀᴛᴇᴅ...⏳**\n" \
                           f"🔗𝐋𝐢𝐧𝐤 » {url}\n" \
                           f"✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝘽𝙃𝘼𝙉𝙐 𝘽𝙊𝙏𝙎🐦](https://t.me/+Mdh299jM2G43MWFl)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.download_and_decrypt_video(url, cmd, name, appxkey)  
                    filename = res_file  
                    await prog.delete(True)  
                    ...
                    Show = f"**⚡Dᴏᴡɴʟᴏᴀᴅɪɴɢ Sᴛᴀʀᴛᴇᴅ...⏳**\n" \
                           f"🔗𝐋𝐢𝐧𝐤 » {url}\n" \
                           f"✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝘽𝙃𝘼𝙉𝙐 𝘽𝙊𝙏𝙎🐦](https://t.me/+MdZ2996g2G93MWFl)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.decrypt_and_merge_video(mpd, keys_string, path, name, raw_text2)
                    filename = res_file
                    await prog.delete(True)
                    ...
                    Show = f"**⚡Dᴏᴡɴʟᴏᴀᴅɪɴɢ Sᴛᴀʀᴛᴇᴅ...⏳**\n" \
                           f"🔗𝐋𝐢𝐧𝐤 » {url}\n" \
                           f"✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝘽𝙃𝘼𝙉𝙐 𝘽𝙊𝙏𝙎🐦](https://t.me/+MdZ2766M6G43MWFl)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.download_video(url, cmd, name)
                    filename = res_file
                    await prog.delete(True)
